...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("SACHIN_MUSIC/assets/font2.ttf", 30)
    font = ImageFont.truetype("SACHIN_MUSIC/assets/font.ttf", 30)
    title_font = ImageFont.truetype("SACHIN_MUSIC/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("SACHIN_MUSIC/assets/play_icons.png")
