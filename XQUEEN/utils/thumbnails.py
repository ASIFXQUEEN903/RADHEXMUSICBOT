...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("XQUEEN/assets/font2.ttf", 30)
    font = ImageFont.truetype("XQUEEN/assets/font.ttf", 30)
    title_font = ImageFont.truetype("XQUEEN/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("XQUEEN/assets/play_icons.png")
