    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            return await message.reply_photo(
                ...
                spoiler=True,  # SPOILER added here
            )
        ...
        if name[:8] == "connect_":
            ...
            try:
                ...
                return await message.reply_text(f"ᴛʜᴇ ᴄʜᴀᴛ ɪᴅ {chat_id} ɪs ɪɴᴠᴀʟɪᴅ.")
            ...
            if message.from_user.id not in admin_ids:
                return await message.reply_text(f"ᴛʜɪs ᴄʜᴀᴛ ɴᴇᴇᴅs ᴀᴅᴍɪɴ ᴘᴇʀᴍɪssɪᴏɴs.")
        ...
        if name[0:3] == "sud":
            ...
            if await is_on_off(2):
                return await app.send_message(
                    ...
                    text=f"{message.from_user.mention} used sudo list.",
                )
            return
        ...
        if name[0:3] == "inf":
            ...
            await app.send_photo(
                ...
                reply_markup=key,
                spoiler=True  # SPOILER here too
            )
            if await is_on_off(2):
                return await app.send_message(
                    chat_id=config.LOGGER_ID,
                    text=f"{message.from_user.mention} checked song info.",
                )
    else:
        out = private_panel(_)
        await message.reply_photo(
            ...
            spoiler=True  # SPOILER for main start image
        )
        if await is_on_off(2):
            return await app.send_message(
                chat_id=config.LOGGER_ID,
...
async def start_gp(client, message: Message, _):
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(out),
        spoiler=True  # SPOILER for group start image
    )
